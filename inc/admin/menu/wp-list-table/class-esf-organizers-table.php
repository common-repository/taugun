...
if ( ! class_exists( 'ESF_Organizers_Post_Table' ) ) {
    ...
    /**
     * ESF_Organizers_Post_Table Class.
     * */
    class ESF_Organizers_Post_Table extends WP_List_Table {
         ...
         * Post type
         * */
        private $post_type = ESF_Register_Post_Types::ORGANIZER_POSTTYPE ;
        ...
        public function prepare_items() {
            ...
            $this->base_url = add_query_arg( array( 'page' => 'organizers' ) , esf_get_event_page_url() ) ;
        ...
        public function get_columns() {
            $columns = array(
                ...
                'organizer' => esc_html__( 'Organizer' , ESF_LOCALE ) ,
        ...
        protected function column_default( $item , $column_name ) {
            ...
            switch ( $column_name ) {
                ...
                case 'info':
                    return $item->get_formatted_info() ;
                    break ;
                case 'actions':
                    $actions             = array() ;
        ...
        private function prepare_item_object( $items ) {
            ...
            if ( esf_check_is_array( $items ) ) {
                foreach ( $items as $item ) {
                    $prepare_items[] = new ESF_Organizer( absint( $item[ 'ID' ] ) ) ;
                }
            }
