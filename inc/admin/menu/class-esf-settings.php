...
if ( ! class_exists( 'ESF_Settings' ) ) {
    ...
    class ESF_Settings {
        ...
        public static function get_settings_pages() {
            ...
            include_once ESF_PLUGIN_PATH . '/inc/abstracts/class-esf-settings-page.php' ;
        ...
        public static function show_messages() {
            if ( count( self::$errors ) > 0 ) {
                ...
                foreach ( self::$messages as $message ) {
                    echo '<div id="message " class="updated inline ' . esc_html( self::$plugin_slug ) . '_save_msg"><p><strong><i class="fa fa-check"></i>' . esc_html( $message ) . '<i class="fa fa-times-circle esf_save_close" aria-hidden="true"></i></strong></p></div>' ;
                }
            }
        }
                ...
                switch ( $value[ 'type' ] ) {
                        ...
                        <tr valign="top">
                            ...
                            <td>
                                ...
                                <div class='<?php echo esc_attr( $value[ 'class' ] ) ; ?>'>
                                    <div class="esf_display_file_names">
                                        <input type="hidden" class="esf_uploaded_file_key" value="<?php echo esc_attr( $value[ 'id' ] ) ; ?>"/>
                                        <?php
                                        if ( esf_check_is_array( $option_value ) ) {
                                            foreach ( $option_value as $file_name => $file_url ) {
                                                ?>
                                                <p class="esf_uploaded_file_name">
                                                    <b>
                                                        <?php esc_html_e( $file_name ) ; ?>
                                                    </b> <span class="esf_delete_uploaded_file">&nbsp;[x]<input type="hidden" class="esf_remove_file" value="<?php echo esc_attr( $file_name ) ; ?>"/></span>
                                                </p>
                                                <?php
                                            }
                                        }
                                    ...
                                    <input type="file" 
                                           name="<?php echo esc_attr( $value[ 'name' ] ) ; ?>"
                                           id="<?php echo esc_attr( $value[ 'id' ] ) ; ?>" 
                                           class="esf_file_upload <?php echo esc_attr( $value[ 'class' ] ) ; ?>"
                                           placeholder="<?php echo esc_attr( $value[ 'placeholder' ] ) ; ?> 
                                           <?php echo implode( ' ' , $custom_attributes ) ; ?>"/>
                                           <?php echo $description ; ?>
                                </div>
                        ...
                        ?><tr valign="top">
                            ...
                            <td>
                                <input
                                    ...
                                    type="text"
                                    value="<?php echo esc_attr( $option_value ) ; ?>"
                                    class="esf_colorpicker <?php echo esc_attr( $value[ 'class' ] ) ; ?>"
                                    placeholder="<?php echo esc_attr( $value[ 'placeholder' ] ) ; ?>"
                                    <?php echo implode( ' ' , $custom_attributes ) ; ?>
                                    /> <?php echo $description ; ?>
                            </td>
                        ...
                        <tr valign="top">
                            ...
                            <td>
                                <select
                                    ...
                                    >
                                        <?php
                                        if ( esf_check_is_array( $value[ 'options' ] ) ) {
                    ...
                    case 'relative_date_selector':
                        ...
                        $default_periods = array(
                            'days'   => esc_html__( 'Day(s)' , ESF_LOCALE ) ,
                            'weeks'  => esc_html__( 'Week(s)' , ESF_LOCALE ) ,
                            'months' => esc_html__( 'Month(s)' , ESF_LOCALE ) ,
                            'years'  => esc_html__( 'Year(s)' , ESF_LOCALE ) ,
                                ) ;
                    ...
                    case 'relative_list_view':
                        ...
                        <tr valign="top">
                            ...
                            <td>
                                <input
                                    name="<?php echo esc_attr( $value[ 'name' ] ) ; ?>[enabled]"
                                    id="<?php echo esc_attr( $value[ 'id' ] ) ; ?>"
                                    type="checkbox"
                                    value="<?php echo esc_attr( $option_value[ 'enabled' ] ) ; ?>"
                                    class="<?php echo esc_attr( $value[ 'class' ] ) ; ?>"
                                    <?php echo implode( ' ' , $custom_attributes ) ; // WPCS: XSS ok.     ?>
                                    /><?php echo isset( $value[ 'list_label' ] ) ? $value[ 'list_label' ] : '' ; ?>&nbsp;
                                <input
                                    name="<?php echo esc_attr( $value[ 'name' ] ) ; ?>[number]"
                                    type="number"
                                    value="<?php echo esc_attr( $option_value[ 'number' ] ) ; ?>"
